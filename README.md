...
## Conventional Commits, Semantic Release и Renovate (GitLab)
...
В результате был сформирован единый процесс, основанный на:

- **Conventional Commits**,
- **Semantic Release**,
- **Renovate**, с приоритетной ориентацией на **GitLab** как основную рабочую
  платформу.
...
## 2. Semantic Release в GitLab CI

В GitLab CI настроен шаг `release`, который запускается при пуше в целевую
ветку.
...
## 4.1 Как работает Renovate под капотом
